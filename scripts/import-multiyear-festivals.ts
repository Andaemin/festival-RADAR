/**
 * 2017~2026 canonical CSV(festival_2017_2026_sanitized.csv) → MultiYearFestivalRecord
 *
 * 실행:
 *   npm run import:multiyear -- --file <csv-path> [--dry-run]
 *   npm run import:multiyear -- --dry-run                (파일 생략 시 prisma/data/festival_2017_2026_sanitized.csv 사용)
 *
...
async function main() {
  ...
  console.log(`모드: ${dryRun ? "DRY-RUN (DB 미변경)" : "실제 적재"}`);
  console.log("");
